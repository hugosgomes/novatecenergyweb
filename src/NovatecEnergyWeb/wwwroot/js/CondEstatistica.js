...
function preencheTableEstatistica(estatistica) {
    ...
    if (estatistica.length > 0) {
       ...
       /* $('#tratNum').html(estatistica[0].trat);
        ...
        $('#naoContSpot').html(Math.ceil(((estatistica[0].pot - estatistica[0].interesse) / estatistica[0].pot) * 100).toString() + '%');

        //visitados nao interessados
        $('#visNaoContNum').html(estatistica[0].vis - estatistica[0].interesse);
        $('#visNaoContSpot').html(Math.ceil(((estatistica[0].vis - estatistica[0].interesse) / estatistica[0].pot) * 100).toString() + '%');
        $('#visNaoContSvis').html(Math.ceil(((estatistica[0].vis - estatistica[0].interesse) / estatistica[0].vis) * 100).toString() + '%');
